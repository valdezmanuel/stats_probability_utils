...
Stats _validateStats(
  ...
  for (
    ...
    expect(
      groupedTableExpected[indexInGroupedTable]['accumulatedRelativeFrecuency'],
  ...
  expect(expectedValues['meanOfGroupedData'],
      stats.getMeanOfGroupedData());
  expect(expectedValues['medianOfGroupedData'],
      stats.getMedianOfGroupedData());
  expect(expectedValues['modeOfGroupedData'],
      stats.getModeOfGroupedData());

  expect(expectedValues['varianceGrouped'],
      stats.getVarianceGrouped());
  expect(expectedValues['standardDeviationGrouped'],
      stats.getStandardDeviationGrouped());
  expect(expectedValues['quartiles'],
      stats.getQuartiles());
  ...
  test('10 values', () {
    _validateStats(
      [2, 1, 4, 3, 2, 2, 6, 8, 10, 9],
      {
        ...
        'frequencies': [
          [1, 1], [2, 3], [3, 1], [4, 1], [6, 1], [8, 1], [9, 1], [10, 1]
        ],
        'mode': [2],
        'median': 3.5,
        'variance': [10.9, 9.81],
